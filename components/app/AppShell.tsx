...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-[100dvh] bg-[#0a0a0a] text-zinc-100">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="flex items-center gap-3 border-b border-white/[0.06] bg-zinc-950 px-4 py-3 lg:hidden">
          <button
            type="button"
